...
<head>
    ...
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/static/Adminbackgroundshipment/js/jquery-1.8.3.min.js"></script>
    <base href="<%=basePath%>">
    ...
    <div class="login-main">
        <form action="Adminbackgroundshipment" class="layui-form" method="post">
            ...
            <div class="layui-form-item">
                ...
                <input type="text" id="user" name="userName" lay-verify="userName" autocomplete="off"
            ...
            <div class="layui-form-item">
                ...
                <input type="password" id="pass" name="password" lay-verify="password" autocomplete="off"
            ...
            <div class="layui-form-item">
                ...
                <div class="pull-right">
                    <button type="button" id="logsf" class="layui-btn layui-btn-primary" lay-submit=""
                            lay-filter="login">
